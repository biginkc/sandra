...
- All 84 CSV cases are terminal: 26 PASS and 58 BLOCKED. BLOCKED rows identify the unavailable clock, fault-injection, identity, side-effect, native-control capability, or incomplete branch coverage; they are not product failures. Each CSV row includes a concrete setup check, next action, and retained-fixture/writer status.
