...
- 🚧 **v2.1 — Operational Visibility + Integrations** — Phase 03 shipped, Phase 05 ready to ship, Phase 04 next
...
- [x] **Phase 05: Prospects Filter Drawer** — REISift-style block-based filter UI on `/properties` (10/10 plans, ready to ship 2026-05-09)
...
- [x] 05-01-PLAN.md — Filter schema + types + URL encode/decode (TDD)
- [x] 05-02-PLAN.md — Migration 055_saved_filters.sql + RLS + 5 base preset seed + integration test
- [x] 05-03-PLAN.md — [BLOCKING] Schema-push checkpoint + types regen (depends on 02)
- [x] 05-04-PLAN.md — Filter→Supabase translator + back-compat URL shim (TDD; equity_pct decision)
- [x] 05-05-PLAN.md — countProspectsForFilter + saved-filters CRUD server actions + multi-user RLS test
- [x] 05-06-PLAN.md — Drawer shell (440px Sheet) + Add-Block picker + URL-state hook + debounce hook
- [x] 05-07-PLAN.md — 23 block components (one per kind) + lazy registry + RTL smoke
- [x] 05-08-PLAN.md — Quick Filters bar (RSC) + Active Filters chips + Save preset inline + Preset dropdown
- [x] 05-09-PLAN.md — page.tsx + prospects-query.ts rewrite; remove 5 inline chips from prospects-table.tsx
- [x] 05-10-PLAN.md — Playwright golden-path smoke + visual review checkpoint in Chrome
