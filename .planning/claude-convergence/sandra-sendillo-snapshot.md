...
- Iteration 4 Fable review at `d7dea23a2ff9e04793f9505e2e3b222f6d136c95`: `BLOCKING: NO`, `APPROVE_MERGE: YES`. Accepted its one low finding: stored snapshot read failures returned the unavailable UI without writing the server log that UI directs operators to inspect. Added structured error reporting and a regression test; exact-head manual and Fable reviews must rerun.
