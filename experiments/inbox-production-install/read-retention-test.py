...
probe=sql(f"""BEGIN;
INSERT INTO inbox_read.boundaries(id,requester_id,org_id,conversation_id,generation,revision,created_at,expires_at,execution_deadline)
VALUES
('{old}','{u}','{o}','{c}','{g}',0,clock_timestamp()-interval '101 years',clock_timestamp()-interval '100 years',NULL),
('{active}','{u}','{o}','{c}','{g}',0,clock_timestamp(),clock_timestamp()+interval '5 minutes',NULL),
('{executing}','{u}','{o}','{c}','{g}',0,clock_timestamp()-interval '9 days',clock_timestamp()-interval '8 days',clock_timestamp()+interval '5 minutes'),
('{recent}','{u}','{o}','{c}','{g}',0,clock_timestamp()-interval '2 days',clock_timestamp()-interval '1 day',NULL);
...
sql(f"INSERT INTO inbox_read.boundaries(id,requester_id,org_id,conversation_id,generation,revision,created_at,expires_at) VALUES('{held}','{u}','{o}','{c}','{g}',0,clock_timestamp()-interval '101 years',clock_timestamp()-interval '100 years')")
