...
if len(accept_evidence['checks'])!=18:raise SystemExit('Expected eighteen accept-proof.py proof groups')
...
print('PR-E accept/recover/operation_status evidence (accept-proof.py) matches its exact source; 18 proof groups bound')
