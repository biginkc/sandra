...
if len(accept_evidence['checks'])!=26:raise SystemExit('Expected twenty-six accept-proof.py proof groups')
...
print('PR-E accept/recover/operation_status evidence (accept-proof.py) matches its exact source; 26 proof groups bound')
