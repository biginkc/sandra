...
BEGIN
 ...
 IF b->>'recipientCount'<>'0' OR b->'blockers'<>'["empty"]'::jsonb OR b->'items'->0->>'exclusion' IS DISTINCT FROM 'contact_suppressed' THEN RAISE EXCEPTION 'Opt-out not reflected in current frozen review';END IF;
