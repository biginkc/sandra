...
CREATE FUNCTION inbox_t2_authenticated_detail.detail_v2(p_org uuid,p_conversation uuid,p_before timestamptz DEFAULT NULL,p_before_id uuid DEFAULT NULL)
...
BEGIN
 ...
 RETURN result;
END $$;
REVOKE ALL ON FUNCTION inbox_t2_authenticated_detail.detail_v2(uuid,uuid,timestamptz,uuid) FROM PUBLIC,anon,authenticated,service_role;
GRANT EXECUTE ON FUNCTION inbox_t2_authenticated_detail.detail_v2(uuid,uuid,timestamptz,uuid) TO authenticated;
COMMIT;
