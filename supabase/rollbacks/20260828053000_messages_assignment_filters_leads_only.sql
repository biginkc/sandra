-- Manual rollback for 20260828053000_messages_assignment_filters_leads_only.
-- Restores the exact production-proven timeout-recovery function from
-- 20260828022800. This broadens Mine and No owner back to every conversation,
-- including prospects and propertyless threads, without changing customer
-- rows. Keep this file outside supabase/migrations so it can never run forward.
