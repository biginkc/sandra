-- Captured once from sandra-crm-test's current production-equivalent definition.
-- Preserve the filter-timeout hotfix and subsequent disposition-review behavior.
set lock_timeout = '5s';
set statement_timeout = '120s';

drop function if exists public.sms_inbox_thread_page_snapshot(timestamptz, text, uuid, uuid, boolean, integer, integer);
