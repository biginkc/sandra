-- 067_merge_duplicate_properties_batch_scope.sql
--
-- Replaces the 066 repair after test DB execution exposed that
-- dialer_batch_items is scoped through dialer_batches, not a direct org_id.
