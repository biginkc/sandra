...
The full cards have a compact horizontal companion that appears after they scroll behind the dashboard navigation. It stays inside the main content well, below the top/mobile navigation and to the right of the desktop sidebar. Narrow screens scroll the strip horizontally; returning to the full cards hides it. The strip uses the same rep-scoped snapshot and exposes recording/talk coverage in its descriptions.
