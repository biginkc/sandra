...
```bash
INIT=$(node "/Users/jarradhenry/Sites/Sandra/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/jarradhenry/Sites/Sandra/.claude/get-shit-done/templates/spec.md.
