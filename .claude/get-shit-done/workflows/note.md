...
- **Global scope**: `/Users/jarradhenry/Sites/Sandra/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jarradhenry/Sites/Sandra/.claude/notes/`)
...
2. Glob `/Users/jarradhenry/Sites/Sandra/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jarradhenry/Sites/Sandra/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jarradhenry/Sites/Sandra/.claude/notes/` — works in any directory
