...
```
Task(
  prompt="Read /Users/jarradhenry/Sites/Sandra/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/jarradhenry/Sites/Sandra/.claude/get-shit-done/templates/VALIDATION.md`
