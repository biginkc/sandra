...
export type ConfiguredStartDatabase=Omit<DialpadConfigurationDatabase,'public'>&{public:Omit<DialpadConfigurationDatabase['public'],'Tables'|'Functions'>&{
 Tables:DialpadConfigurationDatabase['public']['Tables']&{dialpad_inventory_verifications:{Row:VerificationInsert&{id:string};Insert:VerificationInsert;Update:never;Relationships:[]}};
