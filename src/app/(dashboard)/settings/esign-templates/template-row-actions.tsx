  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-xl">
        ...
        {confirmRecentSends && <div className="border-destructive/20 bg-destructive/10 text-destructive rounded-lg border p-3 text-sm">{template.recentSendCount30d > 0 ? `This template was used for ${template.recentSendCount30d} contract${template.recentSendCount30d === 1 ? "" : "s"} in the last 30 days.` : "This template was used recently."} {template.templateOrigin === "dropbox_website" ? "Removing" : "Deleting"} it will not remove existing contract history or signed PDFs.</div>}
