...
const identity = { orgId: "00000000-0000-4000-8000-000000000010", userId: "00000000-0000-4000-8000-000000000011", sessionId: "00000000-0000-4000-8000-000000000012", accessEpoch: "1" };
...
it("drops a delayed preparation when the open conversation changes", async () => {
  ...
  const view = render(<InboxReplyComposer conversationId={conversationA} identity={identity} enabled />);
  ...
  view.rerender(<InboxReplyComposer conversationId={conversationB} identity={identity} enabled />);
...
it("invalidates a frozen review when the operator edits the draft", async () => {
  ...
  render(<InboxReplyComposer conversationId={conversationA} identity={identity} enabled />);
