...
//   4. executes 194500, 080000, and 100000 and inserts the exact Supabase
//      schema_migrations rows in that same transaction.
//
...
export function loadReviewedPlan(planPath = DEFAULT_PLAN_PATH, options = {}) {
  ...
  if (versions.join(",") !== "20260829194500,20260830080000,20260830100000") {
