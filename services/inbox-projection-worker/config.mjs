...
export function databaseConfig(env){
 ...
 if(fixture){
  if(url.hostname!=='127.0.0.1'||url.port!=='5432'||!fixtures.has(url.pathname.slice(1))||env.INBOX_PROJECTION_EXPECT_DATABASE!==url.pathname.slice(1)||mode)throw Error('Invalid owned fixture transport');
